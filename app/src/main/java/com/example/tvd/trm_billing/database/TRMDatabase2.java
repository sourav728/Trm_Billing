...
public class TRMDatabase2 {
    ...
    public TRMDatabase2(Context context) {
        try {
            databasefile = functionCalls.trm_backup2_filestorepath(dbfolder, db_name);
            functionCalls.logStatus("TRM Backup 2 Not Exists");
            dbpath = functionCalls.trm_backup2_filepath(dbfolder) + File.separator + db_name;
    ...
    public void insert_billed_backup2(ContentValues cv) {
